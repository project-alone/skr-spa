...
type StatusText = 'Failed' | 'Completed' | 'Pending'
type ColorText = 'error' | 'success' | 'warning'
type ColorForStatusItem = { text: StatusText; color: ColorText }
interface ColorForStatus {
	failed: ColorForStatusItem
	completed: ColorForStatusItem
	pending: ColorForStatusItem
}

const getStatusLabel = (cryptoOrderStatus: CryptoOrderStatus): JSX.Element => {
	const map: ColorForStatus = {
		failed: {
			text: 'Failed',
			color: 'error',
		},
	...
	const { text, color }: ColorForStatusItem = map[cryptoOrderStatus]
...
export const RecentOrdersTable: FC<RecentOrdersTableProps> = ({ cryptoOrders = [] }) => {
	...
	const handlePageChange = (
		event: React.MouseEvent<HTMLButtonElement> | null | SelectInputProps<string>,
		newPage: number,
	): void => {
		setPage(newPage)
	}
