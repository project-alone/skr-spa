import { Grid, Box, Button, Typography, Stack, ButtonGroup } from '@mui/material'
...
export const BtnVariation: React.FC = () => {
	return (
		<>
			<Grid container spacing={5}>
				<Grid item xs={6}>
...
export const BtnDisabled: React.FC = () => {
	return (
		<>
			<Grid container spacing={5}>
				<Grid item xs={6}>
...
export const GroupBtn: React.FC = () => {
	return (
		<>
			<Grid container spacing={5}>
				<Grid item xs={6}>
