...
import { Select, FormControl, InputLabel, ListItemIcon, ListItemText } from '@mui/material'
...
import { Placeholder, SelectCombo, DefaultFormControl } from '../assets/style/common'
	...
	return (
		<FormControl variant="standard" sx={{ width: '100%' }}>
			...
			<Select
				...
				renderValue={selectItem !== '' ? undefined : () => <Placeholder content="선택" />}
